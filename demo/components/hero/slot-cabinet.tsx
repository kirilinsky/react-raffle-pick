...
export function SlotCabinet() {
  return (
    ...
    >
      <RafflePick.Slots
        length={7}
        chars="⚛raffle0123456789"
        spinInterval={70}
        staggerMs={220}
        className="hero-slots relative z-10 flex gap-1.5 rounded-2 bg-gradient-to-b from-bg-card to-[#f5e8cc] p-4 shadow-[inset_0_2px_4px_rgba(0,0,0,0.18),0_0_0_2px_var(--gold-deep)] max-[600px]:gap-1 max-[600px]:p-2"
        slotClassName="hero-slot relative inline-block h-[clamp(90px,18vw,140px)] w-[clamp(60px,12vw,100px)] overflow-hidden rounded-1 border border-[#d8c8a0] bg-bg-card font-display text-[clamp(48px,9vw,80px)] font-bold leading-[1.4] tabular-nums text-burgundy shadow-[inset_0_2px_4px_rgba(0,0,0,0.2),inset_0_-2px_4px_rgba(0,0,0,0.1)] data-[stopped]:border-green max-[600px]:h-[58px] max-[600px]:w-[34px] max-[600px]:text-[34px]"
      />
