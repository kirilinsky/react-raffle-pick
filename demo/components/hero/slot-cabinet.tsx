      ...
      <div className="inline-flex flex-col items-center">
        ...
        >
          <RafflePick.Slots
            ...
            slotClassName="hero-slot relative inline-block h-[1.25em] w-[clamp(64px,12vw,104px)] overflow-hidden rounded-1 border border-[#d8c8a0] bg-bg-card font-display text-[clamp(48px,8.8vw,78px)] font-bold leading-none tabular-nums text-burgundy shadow-[inset_0_2px_4px_rgba(0,0,0,0.2),inset_0_-2px_4px_rgba(0,0,0,0.1),inset_0_7px_9px_-6px_rgba(0,0,0,0.3),inset_0_-7px_9px_-6px_rgba(0,0,0,0.3)] transition-[border-color] duration-300 data-[stopped]:border-green max-[600px]:w-[38px] max-[600px]:text-[34px]"
          />
