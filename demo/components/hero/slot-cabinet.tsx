...
export function SlotCabinet() {
  return (
    ...
    >
      <RafflePick.Slots
        length={7}
        chars="⚛raffleyou⭐win0123456789"
        spinInterval={70}
        staggerMs={220}
        className="relative z-10 flex gap-1.5 rounded-2 bg-gradient-to-b from-bg-card to-[#f5e8cc] p-4 shadow-[inset_0_2px_4px_rgba(0,0,0,0.18),0_0_0_2px_var(--gold-deep)] max-[600px]:gap-1 max-[600px]:p-2"
        slotClassName="hero-slot relative inline-block h-[1em] w-[clamp(64px,12vw,104px)] overflow-hidden rounded-1 border border-[#d8c8a0] bg-bg-card font-display text-[clamp(48px,8.8vw,78px)] font-bold leading-none tabular-nums text-burgundy shadow-[inset_0_2px_4px_rgba(0,0,0,0.2),inset_0_-2px_4px_rgba(0,0,0,0.1)] data-[stopped]:border-green max-[600px]:w-[38px] max-[600px]:text-[34px]"
      />
